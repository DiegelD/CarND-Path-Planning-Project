...
![equation](https://latex.codecogs.com/png.image?\dpi{110}&space;cost=1-e^{-\frac{\left&space;|&space;\Delta&space;d&space;\right|}{\Delta&space;s}" title="cost=1-e^{-\frac{\left | \Delta d \right|}{\Delta s}" /)
